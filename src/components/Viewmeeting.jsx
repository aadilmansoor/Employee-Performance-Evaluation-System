...
function Viewmeeting() {
  return (
    <>
    <div>
    <div style={{padding:"80px" ,marginLeft:"600px" , marginTop:"200px"}} className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
